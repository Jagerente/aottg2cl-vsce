...
export class GameClass implements IClass {
    ...
    public staticFields: IField[] = [
        { label: 'IsEnding', type: 'bool', description: 'Indicates if the game is currently ending.' },
        { label: 'EndTimeLeft', type: 'float', description: 'Time left before game restarts.' },
        { label: 'Titans', type: 'List(Titan)', description: 'List of titans currently alive.' },
        { label: 'Shifters', type: 'List(Shifter)', description: 'List of shifters currently alive.' },
        { label: 'Humans', type: 'List(Human)', description: 'List of humans currently alive.' },
        { label: 'AITitans', type: 'List(Titan)', description: 'List of AI titans currently alive.' },
        { label: 'AIShifters', type: 'List(Shifter)', description: 'List of AI shifters currently alive.' },
        { label: 'AIHumans', type: 'List(Human)', description: 'List of AI humans currently alive.' },
