    ...
    public instanceMethods: IMethod[] = [
        {
            ...
            parameters: [
                {
                    name: 'other',
                    type: {name: 'Object', typeArguments: []},
                    description: 'The other object that collided.',
                    isOptional: false,
                    isVariadic: false
                }
            ]
            ...
            parameters: [
                {
                    name: 'other',
                    type: {name: 'Object', typeArguments: []},
                    description: 'The other object that is colliding.',
                    isOptional: false,
                    isVariadic: false
                }
            ]
            ...
            parameters: [
                {
                    name: 'other',
                    type: {name: 'Object', typeArguments: []},
                    description: 'The other object that stopped colliding.',
                    isOptional: false,
                    isVariadic: false
                }
            ]
        },
        {
            ...
            parameters: [
                {
                    name: 'character',
                    type: {name: 'Character', typeArguments: []},
                    description: 'The character that hit this object.',
                    isOptional: false,
                    isVariadic: false
                },
                {
                    ...
                    description: 'The name of the attacker or object.',
                    isOptional: false,
                    isVariadic: false
                },
                {
                ...
                },
                {
                    name: 'type',
                    type: {name: 'string', typeArguments: []},
                    description: 'The type of hit (e.g., blade or titan attack).',
                    isOptional: false,
                    isVariadic: false
                }
            ]
        },
        {
            ...
            parameters: [
                {
                    name: 'human',
                    type: {name: 'Human', typeArguments: []},
                    description: 'The human who hooked this object.',
                    isOptional: false,
                    isVariadic: false
                },
                {
                    name: 'hookPosition',
                    type: {name: 'Vector3', typeArguments: []},
                    description: 'The position where the hook hit.',
                    isOptional: false,
                    isVariadic: false
                },
                {
                    ...
                    description: 'True if it was the left hook, false otherwise.',
                    isOptional: false,
                    isVariadic: false
                }
            ]
