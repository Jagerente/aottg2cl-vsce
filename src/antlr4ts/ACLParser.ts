...
export class ACLParser extends Parser {
	...
	public block(): BlockContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << ACLParser.WHILE) | (1 << ACLParser.FOR) | (1 << ACLParser.IF) | (1 << ACLParser.WAIT) | (1 << ACLParser.RETURN) | (1 << ACLParser.BREAK) | (1 << ACLParser.CONTINUE) | (1 << ACLParser.ID) | (1 << ACLParser.PRIVATE) | (1 << ACLParser.SELF) | (1 << ACLParser.NUMBER) | (1 << ACLParser.FLOAT) | (1 << ACLParser.STRING) | (1 << ACLParser.BOOL) | (1 << ACLParser.NULL) | (1 << ACLParser.PLUS) | (1 << ACLParser.MINUS))) !== 0) || ((((_la - 46)) & ~0x1F) === 0 && ((1 << (_la - 46)) & ((1 << (ACLParser.NOT - 46)) | (1 << (ACLParser.LBRACE - 46)) | (1 << (ACLParser.LPAREN - 46)) | (1 << (ACLParser.ANNOTATION_COMMENT - 46)) | (1 << (ACLParser.ANNOTATION_BLOCK_COMMENT - 46)))) !== 0)) {
				{
				{
				this.state = 140;
				this.statement();
	...
	public returnStatement(): ReturnStatementContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if ((((_la) & ~0x1F) === 0 && ((1 << _la) & ((1 << ACLParser.ID) | (1 << ACLParser.SELF) | (1 << ACLParser.NUMBER) | (1 << ACLParser.FLOAT) | (1 << ACLParser.STRING) | (1 << ACLParser.BOOL) | (1 << ACLParser.NULL) | (1 << ACLParser.PLUS) | (1 << ACLParser.MINUS))) !== 0) || _la === ACLParser.NOT || _la === ACLParser.LPAREN) {
				{
				this.state = 202;
				this.expression();
				}
	...
	public multiplicativeExpression(): MultiplicativeExpressionContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			while (((((_la - 31)) & ~0x1F) === 0 && ((1 << (_la - 31)) & ((1 << (ACLParser.MULTIPLY - 31)) | (1 << (ACLParser.DIVIDE - 31)) | (1 << (ACLParser.MODULO - 31)))) !== 0)) {
				{
				{
				this.state = 259;
				_la = this._input.LA(1);
				if (!(((((_la - 31)) & ~0x1F) === 0 && ((1 << (_la - 31)) & ((1 << (ACLParser.MULTIPLY - 31)) | (1 << (ACLParser.DIVIDE - 31)) | (1 << (ACLParser.MODULO - 31)))) !== 0))) {
				this._errHandler.recoverInline(this);
				} else {
					if (this._input.LA(1) === Token.EOF) {
						this.matchedEOF = true;
	...
	public unaryExpression(): UnaryExpressionContext {
		...
		try {
			...
			this._errHandler.sync(this);
			_la = this._input.LA(1);
			if (((((_la - 29)) & ~0x1F) === 0 && ((1 << (_la - 29)) & ((1 << (ACLParser.PLUS - 29)) | (1 << (ACLParser.MINUS - 29)) | (1 << (ACLParser.NOT - 29)))) !== 0)) {
				{
				this.state = 266;
				_la = this._input.LA(1);
				if (!(((((_la - 29)) & ~0x1F) === 0 && ((1 << (_la - 29)) & ((1 << (ACLParser.PLUS - 29)) | (1 << (ACLParser.MINUS - 29)) | (1 << (ACLParser.NOT - 29)))) !== 0))) {
	...
	public static readonly _serializedATN: string =
		...
		"\x17\x17$\'\x03\x02()\x03\x02*-\x03\x02\x1F \x03\x02!#\x04\x02\x1F 00" +
		"\x03\x02\x1A\x1E\x03\x0267\x02\u0142\x02O\x03\x02\x02\x02\x04R\x03\x02" +
		"\x02\x02\x06\\\x03\x02\x02\x02\bb\x03\x02\x02\x02\nq\x03\x02\x02\x02\f" +
		"}\x03\x02\x02\x02\x0E\x88\x03\x02\x02\x02\x10\x8D\x03\x02\x02\x02\x12" +
		"\xA4\x03\x02\x02\x02\x14\xA6\x03\x02\x02\x02\x16\xAC\x03\x02\x02\x02\x18" +
		"\xB4\x03\x02\x02\x02\x1A\xC2\x03\x02\x02\x02\x1C\xC8\x03\x02\x02\x02\x1E" +
		"\x88\x89\x03\x02\x02\x02\x89\x8B\x03\x02\x02\x02\x8A\x88\x03\x02\x02\x02" +
		"\x8B\x8C\x07\x13\x02\x02\x8C\x0F\x03\x02\x02\x02\x8D\x91\x071\x02\x02" +
		"\x8E\x90\x05\x12\n\x02\x8F\x8E\x03\x02\x02\x02\x90\x93\x03\x02\x02\x02" +
		"\x91\x8F\x03\x02\x02\x02\x91\x92\x03\x02\x02\x02\x92\x94\x03\x02\x02\x02" +
		"\x93\x91\x03\x02\x02\x02\x94\x95\x072\x02\x02\x95\x11\x03\x02\x02\x02" +
		"\x96\xA5\x05\b\x05\x02\x97\x98\x05\"\x12\x02\x98\x99\x07\x18\x02\x02\x99" +
		"\xA5\x03\x02\x02\x02\x9A\xA5\x05\x18\r\x02\x9B\xA5\x05\x14\v\x02\x9C\xA5" +
		"\x05\x16\f\x02\x9D\xA5\x05 \x11\x02\x9E\xA5\x05\x10\t\x02\x9F\xA5\x05" +
		"\x1E\x10\x02\xA0\xA1\x07\x11\x02\x02\xA1\xA5\x07\x18\x02\x02\xA2\xA3\x07" +
		"\x12\x02\x02\xA3\xA5\x07\x18\x02\x02\xA4\x96\x03\x02\x02\x02\xA4\x97\x03" +
		"\x02\x02\x02\xA4\x9A\x03\x02\x02\x02\xA4\x9B\x03\x02\x02\x02\xA4\x9C\x03" +
		"\x02\x02\x02\xA4\x9D\x03\x02\x02\x02\xA4\x9E\x03\x02\x02\x02\xA4\x9F\x03" +
		"\x02\x02\x02\xA4\xA0\x03\x02\x02\x02\xA4\xA2\x03\x02\x02\x02\xA5\x13\x03" +
		"\x02\x02\x02\xA6\xA7\x07\t\x02\x02\xA7\xA8\x073\x02\x02\xA8\xA9\x05\"" +
		"\x12\x02\xA9\xAA\x074\x02\x02\xAA\xAB\x05\x10\t\x02\xAB\x15\x03\x02\x02" +
		"\x02\xAC\xAD\x07\n\x02\x02\xAD\xAE\x073\x02\x02\xAE\xAF\x07\x13\x02\x02" +
		"\xAF\xB0\x07\v\x02\x02\xB0\xB1\x05\"\x12\x02\xB1\xB2\x074\x02\x02\xB2" +
		"\xB3\x05\x10\t\x02\xB3\x17\x03\x02\x02\x02\xB4\xB5\x07\f\x02\x02\xB5\xB6" +
		"\x073\x02\x02\xB6\xB7\x05\"\x12\x02\xB7\xB8\x074\x02\x02\xB8\xBC\x05\x10" +
		"\t\x02\xB9\xBB\x05\x1A\x0E\x02\xBA\xB9\x03\x02\x02\x02\xBB\xBE\x03\x02" +
		"\x02\x02\xBC\xBA\x03\x02\x02\x02\xBC\xBD\x03\x02\x02\x02\xBD\xC0\x03\x02" +
		"\x02\x02\xBE\xBC\x03\x02\x02\x02\xBF\xC1\x05\x1C\x0F\x02\xC0\xBF\x03\x02" +
		"\x02\x02\xC0\xC1\x03\x02\x02\x02\xC1\x19\x03\x02\x02\x02\xC2\xC3\x07\r" +
		"\x02\x02\xC3\xC4\x073\x02\x02\xC4\xC5\x05\"\x12\x02\xC5\xC6\x074\x02\x02" +
		"\xC6\xC7\x05\x10\t\x02\xC7\x1B\x03\x02\x02\x02\xC8\xC9\x07\x0E\x02\x02" +
		"\xC9\xCA\x05\x10\t\x02\xCA\x1D\x03\x02\x02\x02\xCB\xCD\x07\x10\x02\x02" +
		"\xCC\xCE\x05\"\x12\x02\xCD\xCC\x03\x02\x02\x02\xCD\xCE\x03\x02\x02\x02" +
		"\xCE\xCF\x03\x02\x02\x02\xCF\xD0\x07\x18\x02\x02\xD0\x1F\x03\x02\x02\x02" +
		"\xD1\xD2\x07\x0F\x02\x02\xD2\xD3\x05\"\x12\x02\xD3\xD4\x07\x18\x02\x02" +
		"\xD4!\x03\x02\x02\x02\xD5\xD6\x05$\x13\x02\xD6#\x03\x02\x02\x02\xD7\xDA" +
		"\x05&\x14\x02\xD8\xD9\t\x04\x02\x02\xD9\xDB\x05$\x13\x02\xDA\xD8\x03\x02" +
		"\x02\x02\xDA\xDB\x03\x02\x02\x02\xDB%\x03\x02\x02\x02\xDC\xE1\x05(\x15" +
		"\x02\xDD\xDE\x07/\x02\x02\xDE\xE0\x05(\x15\x02\xDF\xDD\x03\x02\x02\x02" +
		"\xE0\xE3\x03\x02\x02\x02\xE1\xDF\x03\x02\x02\x02\xE1\xE2\x03\x02\x02\x02" +
		"\xE2\'\x03\x02\x02\x02\xE3\xE1\x03\x02\x02\x02\xE4\xE9\x05*\x16\x02\xE5" +
		"\xE6\x07.\x02\x02\xE6\xE8\x05*\x16\x02\xE7\xE5\x03\x02\x02\x02\xE8\xEB" +
		"\x03\x02\x02\x02\xE9\xE7\x03\x02\x02\x02\xE9\xEA\x03\x02\x02\x02\xEA)" +
		"\x03\x02\x02\x02\xEB\xE9\x03\x02\x02\x02\xEC\xF1\x05,\x17\x02\xED\xEE" +
		"\t\x05\x02\x02\xEE\xF0\x05,\x17\x02\xEF\xED\x03\x02\x02\x02\xF0\xF3\x03" +
		"\x02\x02\x02\xF1\xEF\x03\x02\x02\x02\xF1\xF2\x03\x02\x02\x02\xF2+\x03" +
		"\x02\x02\x02\xF3\xF1\x03\x02\x02\x02\xF4\xF9\x05.\x18\x02\xF5\xF6\t\x06" +
		"\x02\x02\xF6\xF8\x05.\x18\x02\xF7\xF5\x03\x02\x02\x02\xF8\xFB\x03\x02" +
		"\x02\x02\xF9\xF7\x03\x02\x02\x02\xF9\xFA\x03\x02\x02\x02\xFA-\x03\x02" +
		"\x02\x02\xFB\xF9\x03\x02\x02\x02\xFC\u0101\x050\x19\x02\xFD\xFE\t\x07" +
		"\x02\x02\xFE\u0100\x050\x19\x02\xFF\xFD\x03\x02\x02\x02\u0100\u0103\x03" +
		...
		"3\x02\x02\u011E\u0120\x05B\"\x02\u011F\u011E\x03\x02\x02\x02\u011F\u0120" +
		"\x03\x02\x02\x02\u0120\u0121\x03\x02\x02\x02\u0121\u0122\x074\x02\x02" +
		...
		"\x07\x13\x02\x02\u012B\u012C\x073\x02\x02\u012C\u012D\x05\"\x12\x02\u012D" +
		"\u012E\x074\x02\x02\u012E\u0130\x03\x02\x02\x02\u012F\u0128\x03\x02\x02" +
...
export class MultiplicativeExpressionContext extends ParserRuleContext {
	...
	public MODULO(i?: number): TerminalNode | TerminalNode[] {
		if (i === undefined) {
			return this.getTokens(ACLParser.MODULO);
		} else {
			return this.getToken(ACLParser.MODULO, i);
		}
	}
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
...
export class UnaryExpressionContext extends ParserRuleContext {
	...
	public PLUS(): TerminalNode | undefined { return this.tryGetToken(ACLParser.PLUS, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
